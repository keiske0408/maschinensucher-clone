<template>
    <div class="min-h-screen bg-gray-50">
      ...
      <section class="relative bg-cover bg-center bg-no-repeat" 
               style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3')">
        <div class="container mx-auto px-4 py-16 md:py-24">
          ...
          <div class="hidden xl:flex justify-center mt-12">
            <div class="flex flex-wrap justify-center gap-8 max-w-4xl">
              ...
              <div class="text-center text-white">
                <i class="fas fa-check text-blue-400 mr-2"></i>
                <span class="text-lg font-semibold">Über 200.000 Inserate online</span>
              </div>
              <div class="text-center text-white">
                <i class="fas fa-check text-blue-400 mr-2"></i>
                <span class="text-lg font-semibold">Über 11 Millionen Besucher pro Monat</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="py-8 bg-gray-100">
        <div class="container mx-auto px-4">
          <h2 class="text-2xl font-bold mb-6">Ihre zuletzt angesehenen Artikel</h2>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            <div v-for="item in recentItems" :key="item.id" 
              ...
              <div class="p-3">
                ...
                <p v-if="item.price" class="font-bold text-lg">{{ item.price }}</p>
                <div class="mt-2">
      ...
      <!-- Auction Banner -->
      <section class="relative bg-cover bg-center bg-no-repeat py-16" 
               style="background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1586953208448-b95a79798f07?ixlib=rb-4.0.3')">
        <div class="container mx-auto px-4">
          <div class="flex flex-col lg:flex-row items-center justify-center gap-8">
            <div class="text-center lg:text-left">
              <img src="https://via.placeholder.com/300x150/ffffff/000000?text=AUKTION" 
                   alt="Auktion" class="mx-auto lg:mx-0 mb-4">
            </div>
            <div class="text-center lg:text-left">
              <img src="https://via.placeholder.com/250x60/ffffff/000000?text=AUCTION+LOGO" 
                   alt="Auction Logo" class="mx-auto lg:mx-0 mb-4">
              <button class="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">
                Auktion einreichen
              </button>
            </div>
          </div>
            ...
            <div v-for="category in topCategories" :key="category.id" 
              ...
              <div class="relative">
                ...
                <div class="absolute bottom-0 left-0 right-0 bg-white bg-opacity-90 p-4">
                  <span class="text-gray-600 text-sm">{{ category.count.toLocaleString() }}</span>
              ...
              <div class="divide-y divide-gray-200">
                ...
                <div class="p-3 bg-gray-50 text-center cursor-pointer hover:bg-gray-100 transition-colors duration-200">
                  <span class="font-bold text-sm">Mehr <i class="fas fa-plus ml-1"></i></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Sell Machine Banner -->
      <section class="relative bg-cover bg-center bg-no-repeat py-16" 
               style="background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1563770660941-20978e870e26?ixlib=rb-4.0.3')">
        <div class="container mx-auto px-4">
          <div class="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div>
              <button class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-8 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105">
                MASCHINE VERKAUFEN
      ...
      <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div v-for="section in allCategories" :key="section.title" class="space-y-4">
              <h3 class="text-2xl font-bold border-b pb-2">{{ section.title }}</h3>
        ...
        recentItems: [
          {
            ...
            image: 'https://images.unsplash.com/photo-1586953983040-4d30a0c74f9d?ixlib=rb-4.0.3&w=300&h=200&fit=crop',
            type: 'Auktion',
            isAuction: true,
          ...
          },
          {
            ...
            image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&w=300&h=200&fit=crop',
            type: 'Auktion',
            isAuction: true,
            auctionStatus: 'Auktion beendet'
          },
          {
            ...
            category: 'Injektor',
            image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?ixlib=rb-4.0.3&w=300&h=200&fit=crop',
            type: 'Kleinanzeige'
          },
          {
            id: 4,
            ...
            image: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?ixlib=rb-4.0.3&w=300&h=200&fit=crop',
            type: 'Kleinanzeige'
          },
          {
            id: 5,
        ...
        topCategories: [
          {
            ...
            count: 33057,
            image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&w=500&h=200&fit=crop',
            subcategories: [
          ...
          },
          {
            ...
            count: 12732,
            image: 'https://images.unsplash.com/photo-1586953983040-4d30a0c74f9d?ixlib=rb-4.0.3&w=500&h=200&fit=crop',
            subcategories: [
          ...
          },
          {
            ...
            count: 9090,
            image: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?ixlib=rb-4.0.3&w=500&h=200&fit=crop',
            subcategories: [
        ...
        allCategories: [
          ...
          },
          {
            ...
            categories: [
              ...
              { name: 'Metallbearbeitungsmaschinen & Werkzeugmaschinen', count: 33059 },
